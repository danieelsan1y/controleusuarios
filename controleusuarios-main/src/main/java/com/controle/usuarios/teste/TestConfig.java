...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Usuario user1 = new Usuario(null, "Daniel", "daniel@gmail.com", "6299317-5820", "6283063", "79342054144",
				sdf.parse("07/03/1999"), "Ativo");
		Usuario user2 = new Usuario(null, "Danillo", "danillo@gmail.com", "62992417980", "6700124", "81349700100",
